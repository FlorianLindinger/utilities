...
:: set variables
REM Ending ".py_fast_compile" for delete safey of output_folder_path folder deletion! Do not change it to empty or remove from output_folder_path!
set "ending=.py_fast_compile"
