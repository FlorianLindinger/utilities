...
SET "def_packages=numpy matplotlib scipy pandas pyyaml pillow tqdm pyarrow openpyxl opencv-python ipywidgets pywin32 pyserial numba pyside6 html5lib rich tifffile pyautogui nuitka py7zr pywinauto nptdms scipy-stubs cupy-cuda12x nvmath-python lightwaveexplorer types-pyserial scikit-image"
